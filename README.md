# MA-Thesis
Code used in the MA Thesis: Mapping FIMI and DIMI Narratives on Telegram: A Networked Analysis of Dutch-Language Defensive Publics
...
# BERTopic Pipeline
This is the notebook that contains all code used to perform the BERTopic analysis
